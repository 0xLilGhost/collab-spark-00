        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mb-8 space-y-4">
            <div className="flex gap-4 items-center">
              <CreateTeamDialog type="startup" onSuccess={loadData} />
          ...
          {/* Tabs for Startups and Co-founders */}
          <Tabs defaultValue="startups" className="w-full">
            <TabsList className="mb-8">
              <TabsTrigger value="startups">{t("cofounder.startups")}</TabsTrigger>
              <TabsTrigger value="people">{t("cofounder.cofounders")}</TabsTrigger>
            </TabsList>

            <TabsContent value="startups">
              {filteredTeams.length === 0 ? (
                <div className="text-center py-12">
                  <p className="text-muted-foreground">{t("cofounder.noStartups")}</p>
                </div>
              ) : (
