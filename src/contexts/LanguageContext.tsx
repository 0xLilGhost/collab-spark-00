...
const translations = {
  en: {
    ...
    "browse.loadingDesc": "Finding your perfect matches",
    ...
    "auth.signInDesc": "Log in to continue your journey",
    ...
    "message.dialogDesc": "Send a direct message to connect and discuss collaboration opportunities.",
